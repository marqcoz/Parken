...
import static com.parken.parken.ParkenActivity.NOTIFICATION_ALMOST_FINISH_PS;
import static com.parken.parken.ParkenActivity.NOTIFICATION_CAR_FREE;
import static com.parken.parken.ParkenActivity.NOTIFICATION_EP_BOOKED;
import static com.parken.parken.ParkenActivity.NOTIFICATION_EP_BOOKED_OUT;
import static com.parken.parken.ParkenActivity.NOTIFICATION_FINISH_PS;
import static com.parken.parken.ParkenActivity.NOTIFICATION_MOVEMENT;
import static com.parken.parken.ParkenActivity.NOTIFICATION_NEW_RECEIPT;
import static com.parken.parken.ParkenActivity.NOTIFICATION_NEW_SPACE;
import static com.parken.parken.ParkenActivity.NOTIFICATION_ON_THE_WAY;
import static com.parken.parken.ParkenActivity.NOTIFICATION_PARKEN_OUT;
import static com.parken.parken.ParkenActivity.NOTIFICATION_PAYING;
import static com.parken.parken.ParkenActivity.NOTIFICATION_PAYING_CANCEL;
import static com.parken.parken.ParkenActivity.NOTIFICATION_PAYING_OUT;
import static com.parken.parken.ParkenActivity.NOTIFICATION_SESSION_PARKEN;
import static com.parken.parken.ParkenActivity.NOTIFICATION__RECEIPT_PAYED;
...
public class Notificacion extends Notification {
    ...
    private static NotificationCompat.Builder opcNotificaciones(Context c, NotificationCompat.Builder notificacion, int id, String data){
        ...
        switch (id){
            ...
            case ParkenActivity.NOTIFICATION_ON_THE_WAY:

                title = "En camino";
                msg = "Dirígete hacia tu destino. \nEstamos buscando el mejor espacio Parken para ti.";
                action1 = "Navegar";
                action2 = "Cancelar";
                ...
                notificacion
                        ...
                        .setAutoCancel(false)
                        //.setDefaults(Notification.DEFAULT_LIGHTS | Notification.VIB | Notification.DEFAULT_SOUND)
            ...
            case ParkenActivity.NOTIFICATION_EP_BOOKED:


                cerrar(c, NOTIFICATION_ON_THE_WAY);
                cerrar(c, NOTIFICATION_NEW_SPACE);

                title = "Espacio Parken reservado";
                msg = "Se ha reservado el espacio " + data + ".\nTienes 5 minutos para ocuparlo.";
                action1 = "Navegar";
                action2 = "Cancelar";
            ...
            case NOTIFICATION_NEW_RECEIPT:
                ...
                title = "Nueva sanción";
                msg = "Paga tu sanción para poder utilizar Parken.";
                action1 = "Pagar";

                intent = new Intent(c, SancionActivity.class)
                        .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                        .putExtra("Activity", ParkenActivity.NOTIFICATIONS)
                        .putExtra("ActivityStatus", id)
                        .putExtra("Actions", 0)
